                ...
                <div className='router-container'>
                    ...
                    <div className='flex items-center justify-center my-5'>
                        <form onSubmit={submitHandler} className='p-8 max-w-4xl border border-gray-200 shadow-lg rounded-md'>
                            ...
                            {loading ? <Button disabled className="w-full my-4"><Loader2 className='mr-2 h-4 w-4 animate-spin' /> Updating...</Button> : <Button type="submit" className="w-full my-4">Update Job</Button>}
                        </form>
                    </div>
                    {/* <Footer /> */}
                </div>
